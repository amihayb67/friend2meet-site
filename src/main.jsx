...
{/*         <h1 className="text-4xl md:text-6xl font-bold mb-4 font_0">
        ...
        <h1 class="font_0 wixui-rich-text__text" style="line-height:1.1em; text-align:center; font-size:100px;"><span style="letter-spacing:0.1em;" class="wixui-rich-text__text">
